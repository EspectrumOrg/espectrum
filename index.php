    ...
    <section id="sobre-nos" class="sobre-nos fade-in">
        <div class="container">
            ...
            <div class="conteudo">
                ...
                <div class="texto">
                    <p>A Espectrum é uma empresa de tecnologia fundada em 25/02/2025, com a missão de criar projetos de
                        impacto
                ...
                <div class="imagem">
                    <img src="images/Sobre/Good team-bro.svg" alt="Equipe Espectrum">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="contato-content">
                ...
                <div class="formulario">
                    <form action="../Espectrum2/contato/contatoEnviar.php" method="post">
                        <h3>Contato</h3>
